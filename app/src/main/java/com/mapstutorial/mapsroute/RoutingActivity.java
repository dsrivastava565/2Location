...
package com.mapstutorial.mapsroute;
...
public class RoutingActivity extends FragmentActivity {
    ...
    public void getDirections(View view) {
        ...
        routePlan.addWaypoint(new GeoCoordinate(28.753697100000004, 77.50459889999999));

        // END: Airport, YVR
        routePlan.addWaypoint(new GeoCoordinate(28.7113736,77.4643943));
